...
public class TrabajadorResource {
	...
	@GetMapping("/all")
	public ResponseEntity<Page<TrabajadorAllDTO>> getAllTrabajadores (@RequestParam(defaultValue = "0") int page,@RequestParam(defaultValue = "5") int size){
		Pageable pageable = PageRequest.of(page, size);
		Page<TrabajadorAllDTO> trabajadores = trabajadorservice.findAllTrabajadores(pageable);
